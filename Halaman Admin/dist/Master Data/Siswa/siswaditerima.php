...
$query = "
    ...
    FROM datasiswa 
    WHERE STATUS = 'DIVERIFIKASI' AND (NAMA_LENGKAP LIKE '%$searchTerm%' OR NAMA_PANGGILAN LIKE '%$searchTerm%')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Data Siswa yang Telah Diverifikasi</p>
            </div>
                    ...
                    <div class="dataTable-top">
                        ...
                        <div class="dataTable-search">
                            <form method="GET" action="">
                                <input type="hidden" name="ke" value="siswaditerima">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="120px">
                                                <div style="display: flex; gap: 10px;">
                                                    ...
                                                    <a href="index.php?ke=belum_diverifikasi&id=<?= htmlspecialchars($row['ID_SISWA']); ?>" class="btn btn-primary my-2" title="BELUM DIVERIFIKASI">
                    ...
                    <div class="dataTable-bottom">
                        ...
                        <ul class="pagination pagination-primary float-end dataTable-pagination">
                            <?php if ($currentPage > 1) : ?>
                                <li class="page-item">
                                    <a href="index.php?ke=siswaditerima&page=<?= $currentPage - 1; ?>&entries=<?= $resultsPerPage; ?>&search=<?= urlencode($searchTerm); ?>" class="page-link">‹</a>
                                </li>
                            <?php endif; ?>
                            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                                <li class="page-item <?= ($i === $currentPage) ? 'active' : ''; ?>">
                                    <a href="index.php?ke=siswaditerima&page=<?= $i; ?>&entries=<?= $resultsPerPage; ?>&search=<?= urlencode($searchTerm); ?>" class="page-link"><?= $i; ?></a>
                                </li>
                            <?php endfor; ?>
