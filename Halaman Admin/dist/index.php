            ...
            <div class="cont">
                ...
                switch ($hal) {
                    ...
                    case 'tambahPembayaran':
                        include "Administrasi/tambahPembayaran.php"; 
                        break;
                    case 'detailPembayaran':
                        include "Administrasi/detailPembayaran.php"; 
                        break;
                    case 'hapusPembayaran':
                        include "Administrasi/hapusPembayaran.php"; 
                        break;
                    case 'ubahPembayaran':
                        include "Administrasi/ubahPembayaran.php"; 
                        break;
