...
<html lang="en">
    <head>
        ...
        <style>
            ...
            header img {
                max-height: 80px; /* Atur tinggi maksimum logo */
    ...
    <body>
        ...
        <section style="font-size: 12px;   margin-bottom: 2rem;">
            ...
            <div>
                <div class="field-label">
                    ...
                    <span style="margin-left: 20px;">' . $data_siswa['NAMA_LENGKAP'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 69px;">2. Nama Panggilan</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['NAMA_PANGGILAN'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 60px;">3. Tempat/Tgl. Lahir</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['TEMPAT_LAHIR'] . ', ' . date('d-m-Y', strtotime($data_siswa['TGL_LAHIR'])) . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 82px;">4. Jenis Kelamin</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['JENIS_KELAMIN'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 84px;">5. Tinggi Badan</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['TINGGI_BADAN'] . ' cm</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 89px;">6. Berat Badan</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['BERAT_BADAN'] . ' kg</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 12%;">7. Panjang Tangan</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['PANJANG_TANGAN'] . ' cm</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 85px;">8. Panjang Kaki</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['PANJANG_KAKI'] . ' cm</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 20%;">9. Agama</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['AGAMA'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 70px;">10. Alamat Rumah</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['ALAMAT_RUMAH'] . '</span>
                </div>
                <div class="field-label" style="margin-left: 32%; display: flex; align-items: center;">
                    <span style="margin-right: 10px;">Kode Pos</span>:
                    <span style="margin-left: 20px; margin-right:20px;">' . $data_siswa['KODE_POS_RUMAH'] . '</span>
                    <span style="margin-right: 10px;">Telepon </span>:
                    <span style="margin-left: 20px;">' . $data_siswa['TELEPON_RUMAH'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 81px;">13. Asal Sekolah</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['ASAL_SEKOLAH'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 78px;">14. Kelas/Jurusan</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['KELAS_JURUSAN'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 68px;">15. Alamat Sekolah</span>:
                    <span style="margin-left: 20px;">' . $data_siswa['ALAMAT_SEKOLAH'] . '</span>
                </div>
                <div class="field-label" style="margin-left: 32%; display: flex; align-items: center;">
                    <span style="margin-right: 10px;">Kode Pos</span>:
                    <span style="margin-left: 20px; margin-right:20px;">' . $data_siswa['KODE_POS_SEKOLAH'] . '</span>
                    <span style="margin-right: 10px;">Telepon </span>:
                    <span style="margin-left: 20px;">' . $data_siswa['TELEPON_SEKOLAH'] . '</span>
                </div>
            </div>
        </section>
        ...
        <section style="font-size: 12px; line-height: 1.5;   margin-bottom: 2rem;">
            ...
            <div>
                <div class="field-label">
                    ...
                    <span style="margin-left: 20px;">'. $data_ortu_wali['NAMA_AYAH'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 57px;">2. Tempat Lahir Ayah</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['TEMPAT_LAHIR_AYAH'].'</span>
                </div>
                <div class="field-label">
                ...
                <div class="field-label">
                    ...
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PENDIDIKAN_TERAKHIR_AYAH'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 17%;">5. Agama Ayah</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['AGAMA_AYAH'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 86px;">6. Pekerjaan Ayah</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PEKERJAAN_AYAH'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 59px;">7. Alamat Rumah Ayah</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['ALAMAT_RUMAH_AYAH'].'</span>
                </div>
                <div class="field-label" style="margin-left: 34%; display: flex; align-items: center;">
                    <span style="margin-right: 10px;">Kode Pos</span>:
                    <span style="margin-left: 20px; margin-right:20px;">' . $data_ortu_wali['KODE_POS_AYAH'] . '</span>
                    <span style="margin-right: 10px;">Telepon </span>:
                    <span style="margin-left: 20px;">' . $data_ortu_wali['TELEPON_AYAH'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 19%;">10. Nama Ibu</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['NAMA_IBU'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 71px;">11. Tempat Lahir Ibu</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['TEMPAT_LAHIR_IBU'].'</span>
                </div>
                <div class="field-label">
                ...
                <div class="field-label">
                    ...
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PENDIDIKAN_TERAKHIR_IBU'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 106px;">14. Agama Ibu</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['AGAMA_IBU'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 93px;">15. Pekerjaan Ibu</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PEKERJAAN_IBU'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 65px;">16. Alamat Rumah Ibu</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['ALAMAT_RUMAH_IBU'].'</span>
                </div>
                <div class="field-label" style="margin-left: 34%; display: flex; align-items: center;">
                    <span style="margin-right: 10px;">Kode Pos</span>:
                    <span style="margin-left: 20px; margin-right:20px;">' . $data_ortu_wali['KODE_POS_IBU'] . '</span>
                    <span style="margin-right: 10px;">Telepon </span>:
                    <span style="margin-left: 20px;">' . $data_ortu_wali['TELEPON_IBU'] . '</span>
                </div>

                <div class="field-label">
                    <span style="margin-right: 105px;">19. Nama Wali</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['NAMA_WALI'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-left: 20px;">'. $data_ortu_wali['TEMPAT_LAHIR_WALI'].'</span>
                </div>
                <div class="field-label">
                ...
                <div class="field-label">
                    ...
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PENDIDIKAN_TERAKHIR_WALI'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 99px;">23. Agama Wali</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['AGAMA_WALI'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 86px;">24. Pekerjaan Wali</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['PEKERJAAN_WALI'].'</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 58px;">25. Alamat Rumah Wali</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['ALAMAT_RUMAH_WALI'].'</span>
                </div>
                <div class="field-label" style="margin-left: 34%; display: flex; align-items: center;">
                    <span style="margin-right: 10px;">Kode Pos</span>:
                    <span style="margin-left: 20px; margin-right:20px;">' . $data_ortu_wali['KODE_POS_WALI'] . '</span>
                    <span style="margin-right: 10px;">Telepon </span>:
                    <span style="margin-left: 20px;">' . $data_ortu_wali['TELEPON_WALI'] . '</span>
                </div>
                <div class="field-label">
                    <span style="margin-right: 14%;">28. Hubungan Wali</span>:
                    <span style="margin-left: 20px;">'. $data_ortu_wali['HUBUNGAN_WALI'].'</span>
                </div>
            </div>
        </section>
        ...
        <div class="ttd">
            <p>
                Tidore,
                <span style="display:inline-block; width: 4rem;"><span style="border-bottom: 1px dotted #000; padding-bottom: 2px; width: 8em; display: inline-block;"></span></span>
...
$dompdf->setPaper('A4', 'portrait'); // Ubah ke portrait sesuai kebutuhan
